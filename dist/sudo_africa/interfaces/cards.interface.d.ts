import { BillingAddress, Customer, CustomerStatusEnum } from './customer.interface';
export declare enum CardDesignEnum {
    SudoBlack = "SudoBlack",
    SudoWhite = "SudoWhite"
}
export declare enum CardShippingMethodEnum {
    NIPOST = "NIPOST",
    DHL = "DHL"
}
export declare enum CardCurrencyEnum {
    NGN = "NGN",
    USD = "USD"
}
...
export declare enum CardIssuerCountryEnum {
    NGA = "NGA",
    USA = "USA"
}
...
export declare enum CardBrandEnum {
    Verve = "Verve",
    Visa = "Visa",
